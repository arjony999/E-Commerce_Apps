...
import 'package:project/ui/product_details_screen.dart';
import 'package:project/ui/search_screen.dart';
                  ...
                  child: GridView.builder(
                    ...
                    scrollDirection: Axis.horizontal,
                      ...
                      itemBuilder: (context,index){
                        return GestureDetector(onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductDetails(_products[index]))),
                          child: Card(
                            elevation: 3,
                            child: Column(
                              children: [
